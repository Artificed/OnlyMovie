...
public class EditProfile extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if (currentUser != null) {
            ...
            userService.loadUserProfileData(EditProfile.this, userId, profileFullname, profileUsername, profileImageView);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getImageLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> {
            if (result.getResultCode() == RESULT_OK && result.getData() != null) {
                ...
                userService.uploadImageToFirebaseStorage(EditProfile.this, imageUri);
            }
        });
        ...
        editProfileButton.setOnClickListener(v -> {
            ...
            if (!newUsername.isEmpty() || !newFullname.isEmpty()) {
                if (!newUsername.isEmpty()) {
                    userService.updateUsername(EditProfile.this, newUsername);
                }

                if (!newFullname.isEmpty()) {
                    userService.updateFullname(EditProfile.this, newFullname);
                }
                ...
                Toast.makeText(EditProfile.this, "Please modify at least one field", Toast.LENGTH_SHORT).show();
                editProfileButton.setEnabled(true);
                progressBar.setVisibility(View.GONE);
            }
        });
